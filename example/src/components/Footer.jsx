...
export const Footer = () => {
  return (
    ...
    <div className="px-3 pt-9  mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
      <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        <div className="sm:col-span-2">
          ...
          >
            <span className="text-3xl font-bold tracking-wide text-gray-700 uppercase">
        ...
        <div className="space-y-2 text-sm">
          ...
          <div className="flex">
            ...
            <a
              ...
              className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800"
            >
              10 Sanni Adeshina street, lagos
            </a>
          </div>
        </div>
        <div>
      ...
      <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
        <p className="text-sm text-gray-700">
          © Copyright 2023 Kali j Bags. All rights reserved.
        </p>
      </div>
    </div>
    </div>
